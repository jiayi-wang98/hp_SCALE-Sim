...
class systolic_compute_ws_sa_f2_ac_db:
    """
    ...
    def create_ifmap_demand_mat(self):
        ...
        for fc in range(self.col_fold):
            ...
            for fr in range(self.row_fold_demand_matrices):
                ...
                # Merge with overlap so start-to-start matches the intended gap.
                overlap = (this_fold_demand.shape[1] - 1) * skew_factor
                if fr == 0 and fc == 0:
    ...
    def create_filter_demand_mat(self):
        ...
        inter_fold_gap_between = max(self.T - self.arr_row, 0)
    ...
    def create_ofmap_demand_mat(self):
        ...
        inter_fold_gap_prefix = max(self.arr_row + (self.arr_row * skew_factor) - self.arr_row, 0)
        ...
        # self.ofmap_demand_matrix is built via overlap_concat above
