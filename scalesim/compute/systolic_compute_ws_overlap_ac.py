"""
systolic_compute_ws_overlap_ac
overlap only
"""
...
class systolic_compute_ws_overlap_ac:
    """
    ...
    def create_filter_demand_mat(self):
        ...
        inter_fold_gap_between = max(self.T + self.arr_row - fold_len, 0)
    ...
    def create_ofmap_demand_mat(self):
        ...
        inter_fold_gap_prefix = 2 * self.arr_row
